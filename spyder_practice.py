...
if selected == "Student background":
    ...
    col1.markdown(" ")
    col1.markdown(" ")
    col1.markdown("<b>Scholarship holder:</b>",unsafe_allow_html=True)
    ...
    st.markdown(" ")
    st.markdown("<b>Marital status:</b>",unsafe_allow_html=True)
...
if selected=="Parent’s background":
    ...
    col1.markdown(" ")
    col1.markdown(" ")
    col1.markdown("<b>Mother's qualification:</b>",unsafe_allow_html=True)
    ...
    st.markdown(" ")
    st.markdown("<b>Father's qualification:</b>",unsafe_allow_html=True)
    ...
    st.markdown(" ")
    st.markdown("<b>Mother's occupation:</b>",unsafe_allow_html=True)
    ...
    st.markdown(" ")
    st.markdown("<b>Father's occupation:</b>",unsafe_allow_html=True)
    ...
    col1.markdown(" ")
    col1.markdown(" ")
    col1.markdown("<b>Mother's occupation:</b>",unsafe_allow_html=True)
    ...
    st.markdown(" ")
    st.markdown("<b>Mother's qualification:</b>",unsafe_allow_html=True)
    ...
    col1.markdown(" ")
    col1.markdown(" ")
    col1.markdown("<b>Summaries:</b>",unsafe_allow_html=True)
    ...
    col1.markdown(" ")
    col1.markdown("<b>Details:</b>",unsafe_allow_html=True)
...
if selected=="Conclusion":
    ...
    st.markdown("<b>Student’s background analysis:</b>",unsafe_allow_html=True)
    ...
    st.markdown("")
    st.markdown("<b>Parents background analysis:</b>",unsafe_allow_html=True)
    ...
    st.markdown("")
    st.markdown("<b>Target analysis:</b>",unsafe_allow_html=True)
